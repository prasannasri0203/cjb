                                        ...
                                        <div class="shopping-cart">
                                            ...
                                            <div class="product">
                                              <div class="row">
                                                ...
                                                <?php //echo $count = count($value->orderProducts->merchProductImage);?>
                                                <img class="img-responsive" src="{{URL::to('/merchandise-img/' .$value->orderProducts->merchProductImage[0]->image)}}"
>                                                </div>
                                              </div>
                                    ...
                                    @endforeach
                                        ...
                                        <div class="totals-item totals-item-total">
                                           ...
                                           <div class="totals-item totals-item-total">
                                            ...
                                            <span class="totals-value" id="cart-total">£{{$additional_charge->print_price}}</span>
                                        </div>
                                             <div class="totals-item totals-item-total">
