     ...
     <div class="container user_contain">
            <div class="row">
                <div class="col-sm-4 col-sm-offset-1 user_info">
                    <a href="Logged_In_edit.html"><img src="{{ asset('images/userimg.png') }}" class="img-responsive user_img"></a>                   
                    <h2>{{$user_name->name}}</h2>
                </div>
    ...
    <div class="container product_caros" id="mypro_slider_tab">
        <div class="row">
            ...
            <div class="col-md-6 pro_deta">               
                <h3>{{$merchproduct->merchandise_product_name}} <span>
                ...
                <i class="fa fa-heart-o heartin"></i></a></span></h3>
               <p>By <a href="#">{{$user_name->name}}</a></p>
                ...
                @endfor  &nbsp  &nbsp
                <a href="#">{{count($product_review)}}&nbspReviews</a>
               ...
               <form class="form-horizontal" action="/action_page.php">
                  <div class="form-group">
                     ...
                     <div class="col-xs-9 colpickers"> 
                        <label class="control-label">{{str_replace(array('"',']'), '', $variants[1])}}</label>
                    ...
                    <div class="form-group">
                        ...
                        <label class="control-label">{{str_replace(array('"','['), '', $variants[0])}}</label>                       
                        </div>
                    </div>
               		...
               		<div class="form-group">
                        ...
                        @foreach($print_type as $type)
                            ...
                            <input type="checkbox" id="print_type_array<?php echo $i?>" class="print_type_array" data-id="<?php echo $price[$i] ?>" name="print_type_array"
        ...
        @foreach($productList as  $listDetail)   
            <div class="col-md-4 col-sm-6 pa_s">
                <div class="tshirt_cart add_bsk_btn">
                    <img src="{{URL::to('/merchandise-img/' .$listDetail->image)}}" class="img-responsive uploadimg" />
