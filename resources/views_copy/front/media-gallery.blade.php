                ...
                <div class="row">
                    ...
                    @include('front.user-sidebar')
                        <!-- <ul class="left_menu regular slider">
                            ...
                            <li><a href="#"><i class="fas fa-shopping-basket" aria-hidden="true"></i><span> {{ __('media-gallery.Orders') }}</span></a></li>
                            <li><a href="#"><i class="fa fa-eye" aria-hidden="true"></i><span> {{ __('media-gallery.View Shop') }}</span></a></li>
                            <li><a href="#"><i class="fas fa-paint-roller" aria-hidden="true"></i><span> {{ __('media-gallery.Creation Station') }}</span></a></li>
