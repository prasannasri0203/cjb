...
@endphp
 ...
 <h2 style="margin-left: 9em;" >Give Invite to Our Website.</h2>
    <form style="margin-left: 20em;" action="{{ route('refferalCreate') }}" method="post">
    @csrf
      <div>
      ...
      <div>
        ...
        <br />
        <textarea name="description" rows="12" cols="35">Send your comments to us.</textarea>
      </div>
      <div>
