                ...
                <div class="container artist-dashboard">
                    ...
                    <div class="col-lg-2 col-md-3 col-sm-12 col-xs-12  nopad-left-mob">
                        ...
                        <div class="col-lg-10 col-md-9 col-sm-12 col-xs-12">
                            <!--banner-->
                            <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 no-padding container_default_custom">
                        <div class="col-lg-12 col-md-12 col-sm-12 address_book">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 ">
                                <div class="address-book-section">
                                    ...
                                    <span class="edit_book"><a href="{{ URL('address_book/edit/'.$value->id) }}"><i class="fas fa-edit"></i>edit</a></span>
                                </div>
                            </div>
                            @endforeach
                            <div class="col-lg-12 col-md-12 col-sm-12 ">
