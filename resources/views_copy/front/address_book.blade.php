                                ...
                                <div id="Profile" class="tab-pane fade in active">
                                    ...
                                    <div class="header_cont align-top-cont">
                                        <div class="custom_container">
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-12 no-padding label_tt">
                                                <label>{{ __('address_book.Address') }} 1:</label>
                                            </div>
                                            <div class="col-lg-9 col-md-9 col-sm-12 no-padding">
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-12 no-padding label_tt">
                                                <label>{{ __('address_book.Town') }}/{{ __('address_book.City') }}:</label>
                                            </div>
                                            <div class="col-lg-9 col-md-9 col-sm-12 no-padding">
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-12 no-padding label_tt">
                                                <label>{{ __('address_book.Postcode') }}:</label>
                                            </div>
                                            <div class="col-lg-9 col-md-9 col-sm-12 no-padding">
                                            ...
                                            <div class="col-md-9 col-sm-12 no-padding">
                                                ...
                                                <div class="form-group radioclass @error('primary') has-error @enderror">
                                                    <input type="radio" name="primary" class="" id="" value="1" {{ (old('primary') == '1') ? 'checked' : ''}} > {{ __('address_book.primary') }}
                                                    <input type="radio" name="primary" class="" id="" value="0" {{ (old('primary') == '0') ? 'checked' : ''}} >{{ __('address_book.others') }}
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-12 no-padding label_tt">
                                                <label>{{ __('address_book.Country') }}:</label>
                                            </div>
                                            <div class="col-lg-9 col-md-9 col-sm-12 no-padding">
