                ...
                <div class="row" id="cart_item_{{$value['id']}}">
                    ...
                    <div class="col-lg-8 d-flex">
                        ...
                        <form action="#">
                            ...
                            <h2>{{ __('cart.Total') }}: <span id="item_wise_sub_{{$value['id']}}">{{ currency((($value['price'] * $value['quantity']) + ($value['quantity'] *$additional_charge)), 'GBP', session()->get('my_currency'))}}</span></h2>
                            @php 
            ...
            <div  class="table_basket">
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td scope="row">{{ __('cart.Delivery') }}:</td>
...
<!--                             @php $packing_amt = 0; @endphp
                            ...
                            <td class="p-0"><span id="packing_cost">{{ currency($additional_charge, 'GBP', session()->get('my_currency'))}}</span> </td>
						</tr>
