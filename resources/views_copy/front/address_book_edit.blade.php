                                    ...
                                    <div class="header_cont align-top-cont">
                                        <div class="custom_container">
                                            <div class="col-lg-3 col-md-3 col-sm-12 no-padding label_tt">
                                                <label>{{ __('addressbook_edit.First Name') }}:</label>
                                            </div>
                                            <div class="col-lg-9 col-md-9 col-sm-12 no-padding">

                                                <div class="form-group t_tip @error('fname') has-error @enderror">
                                                    <input type="text" name="fname" class="form-control" id="" value="{{ $data->fname }}">
                                            ...
                                            <div class="col-lg-9 col-md-9 col-sm-12 no-padding">
                                                ...
                                                <div class="form-group @error('address1') has-error @enderror">
                                                    <input type="text" name="address1" class="form-control" id="" value="{{ $data->address1 }}">
                                                    @error('address1')
                                                        <span class="help-block">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                            ...
                                            <div class="col-lg-9 col-md-9 col-sm-12 no-padding">
                                                ...
                                                <div class="form-group @error('address2') has-error @enderror">
                                                    <input type="text" name="address2" class="form-control" id="" value="{{ $data->address2 }}">
                                                    @error('address2')
                                                        <span class="help-block">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                            ...
                                            <div class="col-lg-9 col-md-9 col-sm-12 no-padding">
                                                ...
                                                <div class="form-group @error('city_name') has-error @enderror">
                                                    <input type="text" name="city_name" class="form-control" id="" value="{{ $data->city_name}}">
                                                    @error('city_name')
                                                        <span class="help-block">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                            ...
                                            <div class="col-lg-9 col-md-9 col-sm-12 no-padding">
                                                ...
                                                <div class="form-group @error('pscode') has-error @enderror">
                                                    <input type="text" name="pscode" class="form-control" id="" value="{{ $data->pscode}}">
                                                    @error('pscode')
                                                        <span class="help-block">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                            ...
                                            <div class="col-md-9 col-sm-12 no-padding">
                                                ...
                                                <div class="form-group @error('primary') has-error @enderror">
                                                    <input type="radio" value="1" name="primary" {{($data->primary == '1') ? 'checked' : ''}}> {{ __('addressbook_edit.primary') }}
                                                    <input type="radio" value="0" name="primary" {{($data->primary == '0') ? 'checked' : ''}}> {{ __('addressbook_edit.others') }}
