...
@section('header_script')
    ...
    .custom_container .form-group input[type="radio"] {
    width: auto;
    margin: 0;
                    ...
                    <div class="col-lg-10 col-md-9 col-sm-12 col-xs-12 edit_mb_space">
                        ...
                        <div class="edit_pf">
                            ...
                            <ul class="nav nav-tabs">
                                <li class="active"><a data-toggle="tab" href="#Profile">{{ __('addressbook_edit.Details') }}</a></li>
                            </ul>

                            <div class="tab-content">
                                <div id="Profile" class="tab-pane fade in active">
                                    <form method="post" class="form-validate" action="{{ url('address_book/update') }}">
                                    @csrf
                                    <div class="header_cont align-top-cont">
                                        <div class="custom_container">
                                            ...
                                            <div class="col-lg-9 col-md-9 col-sm-12 no-padding">
                                                ...
                                                <div class="form-group t_tip @error('delivery_name') has-error @enderror">
                                                    <input type="text" name="delivery_name" class="form-control" id="" value="{{ $data->delivery_name }}">
                                            ...
                                            <div class="col-lg-9 col-md-9 col-sm-12 no-padding">
                                                ...
                                                <div class="form-group t_tip @error('no') has-error @enderror">
                                                    <input type="text" name="no" class="form-control" id="" value="{{ $data->no }}">
                                            ...
                                            <!-- <div class="col-lg-9 col-md-9 col-sm-12 no-padding">
                                                ...
                                                <div class="form-group t_tip @error('sname') has-error @enderror">
                                                    <input type="text" name="sname" class="form-control" id="" value="{{ $data->sname }}">
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-12 no-padding label_tt">
                                                <label>{{ __('addressbook_edit.Address') }} 1:</label>
                                            </div>
                                            <div class="col-lg-9 col-md-9 col-sm-12 no-padding">

                                                <div class="form-group @error('address1') has-error @enderror">
                                                    <input type="text" name="address1" class="form-control" id="" value="{{ $data->street_1 }}">
                                                    @error('address1')
                                                        <span class="help-block">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                              ...
                                              <div class="col-lg-3 col-md-3 col-sm-12 no-padding label_tt">
                                                <label>{{ __('addressbook_edit.Address') }} 2:</label>
                                            </div>  
                                             <div class="col-lg-9 col-md-9 col-sm-12 no-padding">

                                                <div class="form-group @error('address2') has-error @enderror">
                                                    <input type="text" name="address2" class="form-control" id="" value="{{ $data->street_2 }}">
                                                    @error('address2')
                                                        <span class="help-block">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-12 no-padding label_tt">
                                                <label>{{ __('addressbook_edit.Telephone') }}:</label>
                                            </div>
                                            <div class="col-lg-9 col-md-9 col-sm-12 no-padding">

                                                <div class="form-group @error('phone') has-error @enderror">
                                                    <input type="text" name="phone" class="form-control" id="" value="{{ $data->contact_no }}">
                                                    @error('phone')
                                                        <span class="help-block">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-12 no-padding label_tt">
                                                <label>{{ __('addressbook_edit.Town') }}/{{ __('addressbook_edit.City') }}:</label>
                                            </div>
                                            <div class="col-lg-9 col-md-9 col-sm-12 no-padding">

                                                <div class="form-group @error('city_name') has-error @enderror">
                                                    <input type="text" name="city_name" class="form-control" id="" value="{{ $data->region}}">
                                                    @error('city_name')
                                                        <span class="help-block">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-12 no-padding label_tt">
                                                <label>{{ __('addressbook_edit.Postcode') }}:</label>
                                            </div>
                                            <div class="col-lg-9 col-md-9 col-sm-12 no-padding">

                                                <div class="form-group @error('pscode') has-error @enderror">
                                                    <input type="text" name="pscode" class="form-control" id="" value="{{ $data->zipcode}}">
                                                    @error('pscode')
                                                        <span class="help-block">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-12 no-padding label_tt">
                                                <label>{{ __('addressbook_edit.Primary') }}:</label>
                                            </div>
                                            <div class="col-md-9 col-sm-12 no-padding">

                                                <div class="form-group primary_radio_text @error('primary') has-error @enderror">
                                                    <input type="radio" value="1" name="primary" class="primary_radio_button" {{($data->is_primary == '1') ? 'checked' : ''}}> Default Delivery Address
                                                 {{--  <input type="radio" value="0" name="primary" class="primary_radio_button" {{($data->is_primary == '0') ? 'checked' : ''}}> {{ __('addressbook_edit.others') }}   --}}
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-12 no-padding label_tt">
                                                <label>{{ __('addressbook_edit.Country') }}:</label>
                                            </div>
                                            <div class="col-lg-9 col-md-9 col-sm-12 no-padding">
...
<select class="form-control col-lg-3 col-md-3 col-sm-12 no-padding" name="country" style="padding-left:10px !important;">
 <option value="" selected="selected">Please select country</option> 
   @foreach ($country as $key => $value)
        <option value="{{ $value->countryname }}" {{ ( $data->country == $value->countryname) ? 'selected' : '' }}> 
            {{ $value->countryname }} 
        </option>
    @endforeach 
</select>
                                            ...
                                            <div class="col-lg-9 col-md-9 col-sm-12 no-padding check_box_ct form-end-part">
                                                <div class="btn_group_cards">
                                                    <div class="btn_cards">
                                                        <button type="submit" id="login">{{ __('addressbook_edit.Update') }}</button>
                                                    </div>
                                                </div>
                                            </div>
