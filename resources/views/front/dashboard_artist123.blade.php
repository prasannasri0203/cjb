...
@endphp
        ...
        <!-- modal_start -->
        @if($login == 'register')
        <div class="modal fade changeuser changelog1" id="myModal" role="dialog">
                                    ...
                                    <div class="fm_wrap">
                                        ...
                                        <div class="fm_sec">
                                            <div class="fm_list mariki">
                                                ...
                                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt.</p>
                                                <a href="{{ URL('shop/'.Auth::user()->name) }}" class="btn_common ">{{ __('dashboard-artist.Products') }}</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
