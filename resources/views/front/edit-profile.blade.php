...
.btn_group_cards {
    margin-top: 0;
        ...
        .edit_pf #Profile .form-group.frm_relate span {
    top: -6px;
}
        .form-group.t_tip i {
            right: -20px;
                            ...
                            <div class="tab-content">
                                <div id="Profile" class="tab-pane fade in active">
                                    ...
                                    <div class="header_cont align-top-cont">
                                        <div class="custom_container">
                                            <div class="col-lg-3 col-md-3 col-sm-12 no-padding label_tt">
                                                <label>{{ __('edit-profile.Profile Name') }}:<span class="man_star">*</span></label>
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-12 no-padding label_tt">
                                                <label>{{ __('edit-profile.First Name') }}:<span class="man_star">*</span></label>
                                            </div>
                                            <div class="col-lg-9 col-md-9 col-sm-12 no-padding">
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-12 no-padding label_tt">
                                                <label>{{ __('edit-profile.Last Name') }}:<span class="man_star">*</span></label>
                                            </div>
                                            <div class="col-lg-9 col-md-9 col-sm-12 no-padding">
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-12 no-padding label_tt">
                                                <label>{{ __('edit-profile.Email') }}:<span class="man_star">*</span></label>
                                            </div>
                                            <div class="col-lg-9 col-md-9 col-sm-12 no-padding">
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-12 no-padding label_tt">
                                                <label>{{ __('edit-profile.Address') }} 1:<span class="man_star">*</span></label>
                                            </div>
                                            <div class="col-lg-9 col-md-9 col-sm-12 no-padding">
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-12 no-padding label_tt">
                                                <label>{{ __('edit-profile.Town') }}/{{ __('edit-profile.City') }}:<span class="man_star">*</span></label>
                                            </div>
                                            <div class="col-lg-9 col-md-9 col-sm-12 no-padding">
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-12 no-padding label_tt">
                                                <label>{{ __('edit-profile.Postcode') }}:<span class="man_star">*</span></label>
                                            </div>
                                            <div class="col-lg-9 col-md-9 col-sm-12 no-padding">
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-12 no-padding label_tt">
                                                <label>{{ __('edit-profile.Date of birth') }}:<span class="man_star">*</span></label>
                                            </div>
                                            <div class="col-lg-9 col-md-9 col-sm-12 no-padding">

                                                <div class="form-group t_tip @error('date_of_birth') has-error @enderror" id="date">
                                                    <input type="text" name="date_of_birth" class="form-control" value="{{Auth::user()->dob}}" readonly="readonly" style="background-color: #FFFFFF">
                                            ...
                                            <div class="col-lg-9 col-md-9 col-sm-12 no-padding check_box_ct form-end-part">
                                                ...
                                                <div class="form-group t_tip">
                                                    <div class="checkbox">
                                                        <label><input type="checkbox" name="account_mail" value="1" {{(Auth::user()->account_mail == '1') ? 'checked' : ''}}><p>I’m happy to receive important account related emails from Cool Jelly Bean</p></label>
                                                    </div>
                                                    <div class="checkbox">
                                                        <label><input type="checkbox" name="marketing_mail" value="1" {{(Auth::user()->marketing_mail == '1') ? 'checked' : ''}}><p>I’m happy to receive marketing emails from Cool Jelly Bean</p></label>
                                                    </div>
                                    ...
                                    <div class="header_cont password-sec">
                                        <div class="custom_container">
                                            <div class="col-lg-3 col-md-3 col-sm-12 no-padding label_tt">
                                                <label>Current Password:<span class="man_star">*</span></label>
                                            </div>
                                            <div class="col-lg-9 col-md-9 col-sm-12 no-padding">
                                                <div id="show_hide_password" class="form-group frm_relate t_tip">
                                                <div class="form-group @error('c_password') has-error @enderror">
                                                    <input id="password-field-2" type="password" class="form-control" name="c_password" ><span toggle="#password-field" class="fa fa-fw field-icon toggle-password2 fa-eye-slash eye_password" aria-hidden="true"></span>
                                                    @error('c_password')
                                                        <span class="help-block">
                                                            <strong>{{ @$message }}</strong>
                                                        </span>
...
<!--                                                         <a href=""><i class="fa fa-eye-slash" aria-hidden="true"></i></a> -->
                                    ...
                                    <div class="header_cont password-sec">
                                        <div class="custom_container">
                                            <div class="col-lg-3 col-md-3 col-sm-12 no-padding label_tt">
                                                <label>New Password:<span class="man_star">*</span></label>
                                            </div>
                                            <div class="col-lg-9 col-md-9 col-sm-12 no-padding">
                                                <div id="show_hide_password" class="form-group frm_relate t_tip">
                                                <div class="form-group @error('password') has-error @enderror">
                                                    <input id="password-field-1" type="password" class="form-control" name="password" value=""><span toggle="#password-field" class="fa fa-fw field-icon toggle-password fa-eye-slash eye_password" aria-hidden="true"></span>
                                                    @error('password')
                                                        <span class="help-block">
                                                            <strong>{{ @$message }}</strong>
                                                        </span>
...
<!--                                                         <a href=""><i class="fa fa-eye-slash" aria-hidden="true"></i></a> -->
                                            ...
                                            <div class="col-lg-9 col-md-9 col-sm-12 no-padding check_box_ct form-end-part">
                                                <div class="btn_group_cards mt-0">
                                                    <div class="btn_cards mobw100">
                                                        <button type="submit" id="btn_mobAuto" style="margin-left: 205px;">{{ __('Save Password') }}</button>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    @if(@$user_detail->type != 2)
                                            <form method="post" class="form-validate" action="{{ url('edit-profile/paymentInfo') }}">
                                            @csrf
                                            ...
                                            <div class="header_cont password-sec">
                                                <div class="custom_container">
                                                    ...
                                                    <div class="col-lg-3 col-md-3 col-sm-12 no-padding label_tt">
                                                        <label>Bank Name:<span class="man_star">*</span></label>
                                                    </div>
                                                    <div class="col-lg-9 col-md-9 col-sm-12 no-padding">

                                                        <div class="form-group @error('bank_name') has-error @enderror">
                                                            <input type="text" name="bank_name" class="form-control" id="" value="{{Auth::user()->bank_name}}">
                                                            @error('bank_name')
                                                                <span class="help-block">
                                                                    <strong>{{ @$message }}</strong>
                                                                </span>
                                                    ...
                                                    <div class="col-lg-3 col-md-3 col-sm-12 no-padding label_tt">
                                                        <label>Sort Code:<span class="man_star">*</span></label>
                                                    </div>
                                                    <div class="col-lg-9 col-md-9 col-sm-12 no-padding">

                                                        <div class="form-group @error('sort_code') has-error @enderror">
                                                            <input type="text" name="sort_code" class="form-control" id="" value="{{Auth::user()->sort_code}}">
                                                            @error('sort_code')
                                                                <span class="help-block">
                                                                    <strong>{{ @$message }}</strong>
                                                                </span>
                                                    ...
                                                    <div class="col-lg-3 col-md-3 col-sm-12 no-padding label_tt">
                                                        <label>Account no.:<span class="man_star">*</span></label>
                                                    </div>
                                                    <div class="col-lg-9 col-md-9 col-sm-12 no-padding">

                                                        <div class="form-group @error('account_number') has-error @enderror">
                                                            <input type="text" name="account_number" class="form-control" id="" value="{{Auth::user()->account_number}}">
                                                    ...
                                                    <div class="col-lg-3 col-md-3 col-sm-12 no-padding label_tt">
                                                        <label>Account Holder Name:<span class="man_star">*</span></label>
                                                    </div>
                                                    <div class="col-lg-9 col-md-9 col-sm-12 no-padding">

                                                        <div class="form-group @error('account_holder_name') has-error @enderror">
                                                            <input type="text" name="account_holder_name" class="form-control" id="" value="{{Auth::user()->account_holder_name}}">
                                                    ...
                                                    <div class="col-lg-9 col-md-9 col-sm-12 no-padding check_box_ct form-end-part">
                                                        <div class="btn_group_cards mt-0">
                                                            <div class="btn_cards mobw100">
                                                                <button type="submit" id="btn_mobAuto" style="margin-left: 205px;">{{ __('Save Details') }}</button>
                                                            </div>
                                                        </div>
                                                    </div>
...
$(document).ready(function() {
     $(".toggle-password").click(function(){
                ...
                $(".toggle-password2").click(function(){
                    var input = $("#password-field-2");
                    if($('#password-field-2').attr('type') != 'password')
                    {
