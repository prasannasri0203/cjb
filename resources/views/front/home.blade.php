                ...
                <div id="headcarouselid" class="carousel slide" data-ride="carousel">
                    ...
                    <?php if($y!=0){$active = '';} ?>
                        <div class="item {{$active}} {{$y}}">
                            <img width="1920px;" height="473px;" src="{{ asset('/banner_image').'/'.$data->image_file_name }}" class="dsktp_banner" title="slidepicture" alt="slidepicture">
                        ...
                        @foreach ($featured_video as $video )
                            ...
                            <li class="responsiveGallery-item div-video">
                                <button class="btn btn-primary btn-sm video" data-video="{{ 'https://www.youtube.com/embed/'.$url }}" data-toggle="modal" data-target="#videoModal">
                                    ...
                                    <img src="{{ asset('images/playicon.png') }}" style=" width: 50px;
                                    border-radius: 50%;
                                    position: absolute;
                                    left: 40%;
                                    top: 40%;">
            ...
            <div class="row no-margin">
                <div class="container">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 steps-blk">
                        ...
                        <a href="{{ URL::to('detailpage/9')}}"><button class="registr_btn btn_cards">READ MORE</button></a>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-12 steps-blk">
                        <img src="images/helpguide_img2.png" alt="">
                        <p class="blue_clr">{{ __('home.How does it work?') }}</p>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt.</p>
                       <a href="{{ URL::to('detailpage/10')}}"><button class="registr_btn btn_cards">READ MORE</button></a>
                    </div>
                    <div class="col-lg-4 col-md-4  col-sm-12 steps-blk">
