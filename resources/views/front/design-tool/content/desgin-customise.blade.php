                 ...
                 .image_tools {
                                   ...
                                   <div id="Customise" class="tab-pane fade in active ">
                                       ...
                                       <div class="container-fluid product_editor crebb ipad_pfrm">
                                         <div class="row">
                                          <div id="shirtDiv" class="col-sm-6">
                                           <img src="{{ asset('portal/img/product') }}/{{$desgin_data['img']}}" alt="" class="img-responsive edituser_img edituser_img img-invert" id="tshirtFacing">
                                           @if($desgin_data['prd_drw_wdh'] == 400)
                                           <div id="drawingArea"
                                           style="position: absolute;top: 10px;left: 62px;z-index: 10;width: 200;height: 360;">
                                           <canvas id="tcanvas" width="{{$desgin_data['prd_drw_wdh']}}" height="{{$desgin_data['prd_drw_ht']}}" class="hover" style="-webkit-user-select: none;"></canvas>
                                         </div>
                                         @else
                                         <div id="drawingArea"
                                     ...
                                     <div class="col-sm-6 desgin_form">
                                       <h3>{{$product_variant->variant_name}} 
                                         <!--  @if(isset($product_variant->product_variant_ref_no))  ({{$product_variant->product_variant_ref_no}} ) @endif -->
                                       </h3>
                                          ...
                                          <div class="form-group">
                                           ...
                                           <div class="col-sm-7">
                                            ...
                                            <input type="hidden" name="mer_price" id="mer_price" class="boldprice1">
                                                     ...
                                                     <!--  @if(isset($product_variant->product_variant_ref_no)) 
                                                       <div class="form-group ">
                                                           <label class="control-label col-sm-5 ">Product Reference No:</label>
                                                           <div class="col-sm-7 sign_sym"> 
                                                              <input name="product_variant_ref_no" id="product_variant_ref_no" type="number" class="form-control" readonly="readonly" value="{{$product_variant->product_variant_ref_no}}" min="0">  
                                                     ...
                                                     <div class="form-group">
                                                       ...
                                                       <div class="col-sm-7 colpickers">
                                                        ...
                                                        { 
                                                          ...
                                                          $colorCode=[];
                                                          $clr_code=$clr;
                                                          $colorCode=ProductOptionValue::where('name',$clr_code)->get();
                                                          ...
                                                          <div>
                                                            ...
                                                            <a href="{{url('/design-creation/'.$test['id'][0])}}?check=approved&clr={{$clr}}" > 
                                                              <span class="colorpicker"  id="colorpicker_{{$vart->id}}" style="background: {{$clr_code}}"></span></a>
                                                              <!-- </a> -->
