                    ...
                    <div class="item">
                        ...
                        <div class="container">
                            <div class="caption hlp_caption ">
                                <p>IDEAS - Fusce malesuada imperdiet lacus id vestibulum. </p>
                            </div>
                        </div>
                    </div>
                    <div class="item">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 no-padding">            
            <div class="col-lg-12 col-md-12 col-sm-12  ">
                ...
                <div class="ideas_text">
                 ...
                 <div class="ideas_text">
                    <h4>GOVERNING LAW</h4>
                    <p>These Terms shall be governed by and defined following the laws of India. Cool Jelly Bean and yourself irrevocably consent that the courts of India shall have exclusive jurisdiction to resolve any dispute which may arise in connection with these terms.</p>
                </div>
