...
@section('content')
    ...
    <section id="checkout_completed_log" class="container_default_custom completed_log comp_guest_check">
        <div class="log-out">
            <h3>{{ __('password-reset.Reset Password') }}</h3>
            ...
            @if (session('success'))
               ...
               @endif
                ...
                <form method="post" class="form-validate" action="{{ url('password/email') }}">
                @csrf
                <input type="hidden" class="form-control" value="users" name="type" />

                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 no-padding">
                    <label>{{ __('password-reset.Email') }}: </label>
                </div>
                ...
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 no-padding">
                    <div class="btn_group_cards">
                        <div class="btn_cards">
                        	<button type="submit" class="btn btn-success">{{ __('password-reset.Send Password Reset Link') }}</button>
                        </div>
                    </div>
                </div>
                </form>
