    ...
    <div class="row">
        ...
        <div class="col-lg-10 col-md-9 col-sm-12 col-xs-12 edit_mb_space">
            ...
            <div class="base-wrapper">
                <h2 class="page-h">Become an Agent and help you and your friends earn monies. Its really simple and great fun!</h2>
        
                <div class="page-cnt">
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-xs-12 col-sm-12 cnt-inner">
                            <img src="{{url('images/affiliate_images/a1.jpg')}}">
                            <h2>Invite your friends</h2>
                            <p>If you know people who have followers, are great at design, or just into fashion then you send them a link to set up a shop.</p>
                        </div>

                        <div class="col-lg-4 col-md-4 col-xs-12 col-sm-12 cnt-inner">
                            <img src="{{url('images/affiliate_images/a2.jpg')}}">
                            <h2>Get commission</h2>
                            <p>Your friend can start selling personalised products to earn money, and you earn commission on everything they sell! </p>
                        </div>

                        <div class="col-lg-4 col-md-4 col-xs-12 col-sm-12 cnt-inner">
                            <img src="{{url('images/affiliate_images/a3.jpg')}}">
                            <h2>Spread the word</h2>
                            <p>The more you help your friend market the page and increase their sales, the more you both can earn.</p>
                        </div>
                    </div>
                </div>

                <div class="btn-area">
                    <a href="{{url('affiliate_list')}}"><button class="start-nw-btn">Start Now</button></a>
                </div>
            </div>
        </div>
