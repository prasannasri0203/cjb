        ...
        <div class="col-lg-10 col-md-9 col-sm-12 col-xs-12 edit_mb_space">
            ...
            <div class="base-wrapper">
                ...
                <div class="btn-area">
                    ...
                    @if(@$fa_status == 0)
                        <form method="post" action="{{url('/2fa-status')}}">
                        @csrf
                            <input type="hidden" value="{{@$fa_status}}" name="fa_status">
                            <a href="#"><input type="submit" value="Active" class="start-nw-btn"></a>
                        </form>
                         @endif
                    @if(@$fa_status == 1)
                        <form method="post" action="{{url('/2fa-status')}}">
                            @csrf
                                <input type="hidden" value="{{@$fa_status}}" name="fa_status">
                                <a href="#"><input type="submit" value="Deactive" class="start-nw-btn"></a>
                        </form>
                    @endif
                </div>
            </div>
