        ...
        <div class="banner">
            <div class="container-fluid" id="headcarousel_container" style="padding: 0;">
                <div id="headcarouselid" class="carousel slide" data-ride="carousel">
                    ...
                    @if((int)$bannerCounter > 0)
                
                    @php $x=0; @endphp
                
                    @foreach($banner as $data_image)
                    <ul class="carousel-indicators">
                        <li class="active" data-target="#headcarouselid" data-slide-to="{{$x}}"></li>
                    </ul>
                    @php $x++; @endphp
                    @endforeach
                    <!-- Wrapper for slides -->
                    ...
                    @foreach($banner as $data_image)
                    <?php if($y!=0){$active = '';} ?>
                        <div class="item {{$active}} {{$y}}">
                            <img width="1920px;" height="473px;" src="{{ asset('/banner_image').'/'.$data_image->image_file_name }}" class="dsktp_banner" title="slidepicture" alt="slidepicture" height="470px;" width="1920px;">
                            ...
                            <div class="container">
                                <div class="caption">
                                    ...
                                    <div class="advertise_btn">
                                        <!-- <a class="regModel">{{ __('home.Register Now') }}</a> --></div>
                                </div>
                            </div>
                        </div>
                    @php $y++; @endphp
            ...
            <div class="row no-margin">
                <div class="container">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 steps-blk">
                            ...
                            <button class="registr_btn cht_mail_btn chat-button"><a style="color: white;" href="https://tawk.to/chat/5ebd661a8ee2956d73a124ac/default">{{ __('help.CHAT') }}</a></button>
                    ...
                    <form class="form-horizontal" action="{{ url('enquiry_details') }}" method="POST" >
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-9 col-xs-12 logbt">
                                <button class="btn btn-default" type="submit" style=" border: 1px solid #ccc !important;" >Save</button>
        ...
        <section id="responsiveGallery-container" class="responsiveGallery-container">
            <div class="container">
                ...
                <a class="responsiveGallery-btn responsiveGallery-btn_prev" href="javascript:void(0);">
                    <i class="fa fa-angle-left" style="font-size:35px;color:#fff" aria-hidden="true"></i>
                </a>
              <a class="responsiveGallery-btn responsiveGallery-btn_next" href="javascript:void(0);">
                    <i class="fa fa-angle-right" style="font-size:35px;color:#fff" aria-hidden="true"></i>
                </a>

                <ul class="responsiveGallery-wrapper">
                    @if($featured_video->count() == 1)
                        @foreach ($featured_video as $video)
                            ...
                            @endphp
                        <li class="responsiveGallery-item div-video" >
                            <button class="btn btn-primary btn-sm video" data-video="{{ 'https://www.youtube.com/embed/'.$url }}" data-toggle="modal" data-target="#videoModal">
                                ...
                                <img src="https://cjb.colanonline.in/images/playicon.png" style=" width: 50px;border-radius: 50%;position: absolute;left: 40%;top: 40%;">
                            </button>
                        </li>
                        @endforeach
                    @else
