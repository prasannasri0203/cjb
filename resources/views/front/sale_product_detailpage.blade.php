...
@section('title', 'Sale Order Information')
                                ...
                                <div class="filtersec order_filter">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <h3>Sale Order Information - {{ $order_details->order_id}}</h3>
                                        ...
                                        <table class="table odered_lists" cellpadding="0" cellspacing="0" border="0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>{{$order_details->customerBillingAddress->delivery_name}}</td>
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li>
                                                                <span> Choosed Option:</span>
                                                                   </span>{{@$value->orderProducts->name_creation}}</span>
