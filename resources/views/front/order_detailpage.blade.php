...
<style>
    ...
    @media (max-width: 767px){
        ...
        .order_details_header .product-details {
            width: auto !important;
        }
        .order_details_header .product-image {
            width: 100% !important;
            margin: 0 auto;
            text-align: center;
            display: block;
        ...
        .order_details_header .product .product-image img {
            width: 100%;
            display: block;
            text-align: center;
            float: none !important;
        ...
        .order_details_header h4.mob_display{
        ...
        <div class="container dashbo">
            <div class="row">
                ...
                <div class="col-lg-10 col-md-9 col-sm-12 col-xs-12 nopadding">
                    ...
                    <div id="cust_men_one" class="advertise_sec2 advertise_over order_details_header order_details_header_comm">
                        <!--sales_stas-->
                        ...
                        <div class="sales_stats orders_tab order_details">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table odered_lists" cellpadding="0" cellspacing="0" border="0">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>{{ (($order_details->status ==1) ? 'Pending' :( ($order_details->status ==2) ? 'Completed' : (($order_details->status ==3) ? 'Cancelled' : 'Completed') ) )}}</td>
                                                    <!--  <td>{{($shippingDate['shipping_date']==null)?'Not Available': $shippingDate['shipping_date']}}</td>
                                        ...
                                        @php // dd($order_details->orderItemDetails); @endphp
                                        ...
                                        <div class="shopping-cart">
                                            ...
                                            <div class="product">
                                                <div class="product-image">
                                                    ...
                                                    @if($value['orderProducts']['merchProductImage'] != '')
                                                    @php  $offset = count( $value['orderProducts']['merchProductImage'])-1; @endphp
                                                    @endif  
                                                    @if($value['orderProducts']['merchProductImage'] != '' && count($value['orderProducts']['merchProductImage'])>0)
                                                ...
                                                <div class="product-details">
                                                    ...
                                                    <div class="product-title">
                                                        {{@$value->orderProducts->name_creation}}    
                                                    </div>
                                                    <br>
                                                    @if($order_details->status == 2)

                                                    @if(($order_details->return_status == 1) && !(in_array($value->merchandise_product_id,$return_array)) )

                                                    <a href="#" class="return_order" data-name="{{ $value->orderProducts->name_creation}}" data-id="{{ $value->orderProducts->id }}" data-toggle="modal" data-target="#return_popup"> Return </a>
                                                    
                                                    @endif
                                                    <a href="#" class="review_order" data-name="" data-id="" data-toggle="modal" data-target="#myModal"> Review </a> 
                                                    @endif 
                                                    <a href="#" class="review_order" data-name="" data-id="{{$value->orderProducts->id}}" data-toggle="modal" data-target="#mytrackhistoryModal_{{$value->orderProducts->id}}" onclick="tracking('{{$value->merchandise_product_id}}')"> Tracking History </a>
                                                </div>

                                                <!--tracking history Modal -->
                                                <div class="modal fade" id="mytrackhistoryModal_{{$value->orderProducts->id}}" role="dialog">
                                                    <div class="modal-dialog">
                                                      ...
                                                      <div class="table-responsive">
                                                        ...
                                                        <tbody> 
                                                            <?php
                                                            $itemid =$value->orderProducts->id; 
                                                            ?>
                                                            @php $i=1 @endphp
                                                            @foreach($shippingInfo as $index => $shiping)
                                                            @if($itemid == $shiping->item_id)
                                                            <tr> 

                                                                <th>  {{ $index + 1}}</th>
                                                                <th>{{ $shiping['order_id'] }}</th> 
                                                                <th>{{ optional($shiping->trackingList->orderTrackProducts)->name_creation }}</th>
                                                                <th>{{ $shiping['created_at']}}</th>
                                                                @if ($shiping['status'] == 1)
                                                                <th>Ready To Ship</th>
                                                                @elseif ($shiping['status'] == 2)
                                                                <th>Shipped</th>
                                                                @elseif ($shiping['status'] == 3)
                                                                <th>Arrived Hub</th>
                                                                @elseif ($shiping['status'] == 4)
                                                                <th>Out for Delivery</th>
                                                                @elseif ($shiping['status'] == 5)
                                                                <th>Delivered</th>
                                                                @elseif ($shiping['status'] == 6)
                                                                <th>Cancelled</th>
                                                                @endif
                                                            </tr>
                                                            @endif
                                ...
                                <div class="product_author">
                                    <span><a href="{{url('shop/'.$value->orderProducts->artistDetails->name)}}">By Mr/Mrs {{ isset($value->orderProducts->artistDetails->name) ? $value->orderProducts->artistDetails->name  : '' }}</a></span>
                                </div>
                                <div class="product-description">
                                    <ul>
                                        <li>
                                            ...
                                            <span style="font-weight: 800;">
                                                <?php
                                                if (isset($value->orderProducts->product_price) && $value->orderProducts->product_price != '') {
                                                    ?>
                                                    {!! currency($value->orderProducts->product_price, 'GBP', session()->get('my_currency')) !!}
                                                    <?php
                                                }
                                                ?>
                                            </span>
                                        ...
                                        </span>{{@$value->orderProducts->name_creation}}{{@$value->productVariant->attributes}} </span>
                                    ...
                                    <li>
                                        <span> TOTAL:</span>
                                        <span>
                                            <?php if (isset($value->orderProducts->product_price) && $value->orderProducts->product_price != '') {
                                                ?>
                                                {!! currency($value->product_quantity * $value->orderProducts->product_price, 'GBP', session()->get('my_currency')) !!}
                                                <?php
                                            }
                                            ?>
                                        </span>
                                        ...
                                        <div class="totals">
                                            ...
                                            <div class="totals-item totals-item-total">
                                                ...
                                                <div class="totals-value" id="cart-total">
                                                    {!! currency($order_details->sub_total, 'GBP', session()->get('my_currency')) !!}
                                                </div>
                                                <label>Delivery Total<i>({{$order_details->delivery_name}})</i>:</label>
                                                <div class="totals-value" id="cart-total">
                                                    {!! currency($order_details->delivery_amount, 'GBP', session()->get('my_currency')) !!}
                                                </div>
                                                <label>Packing Total<i>({{$order_details->packing_name}})</i>:</label>
                                                <div class="totals-value" id="cart-total">
                                                    {!! currency($order_details->packing_amount, 'GBP', session()->get('my_currency')) !!}
                                                </div>
                                                <label>Additional Charge:</label>
                                                <div class="totals-value" id="cart-total">
                                                    @if($additional_charge != 'null' && $additional_charge !='')
                                                    {!! currency(($additional_charge != 'null' || $additional_charge !='') ? $additional_charge->print_price : '', 'GBP', session()->get('my_currency')) !!}
                                                    @endif    

                                                </div>
                                                <label>Order Total:</label>
                                                <div class="totals-value" id="cart-total">
                                                    {!! currency($order_details->grand_total, 'GBP', session()->get('my_currency')) !!}
                                                </div>
                                            </div>
                                        </div>
<!--                                    <p><b>Commission:</b></p>
                                                        ...
                                                        <div class="col-lg-12">
                                                            ...
                                                            <tbody>
                                                              ...
                                                              <tr>
                                                                ...
                                                                <th>{{ optional($value->trackingList->orderTrackProducts)->name_creation }}</th> 
...
<!-- @foreach($order_details->orderItemDetails as $val) -->
            ...
            <div class="modal-body">
                <form class="form-horizontal"  enctype="multipart/form-data" action="{{ url('fault_add') }}" method="POST" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 col-xs-12">
                            <input required type="file" class="form-control" id="profileUpload" name="fault_image[]" maxlength="10" id="usr" value="{{ old('fault_image') }}" multiple onchange="updateImage(event)">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-3 col-sm-9 col-xs-12 logbt">
                            ...
                            <button class="btn btn-default" id="submit" type="submit">Save</button>
...
<script type="text/javascript">
    $('#submit').on("click",function(){
        var t= $('#usr').val();
        if(t != ''){
            var ext = $('#usr').val().split('.').pop().toLowerCase();
