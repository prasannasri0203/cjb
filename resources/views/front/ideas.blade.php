        ...
        <div class="col-lg-12 col-md-12 col-sm-12 no-padding ideas_section">
            <div class="col-lg-6 col-md-6 col-sm-12 no-padding">
                ...
                @foreach(json_decode($ideas->images) as $key => $image)
                            ...
                            @else
                            <img src="{{asset('/images/nomage.png')}}"/>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 pl-0">
                <div class="sub_image_gallery">
                    <div class="gallery_img">
                         <?php 
                            ?>
                            @if(json_decode($value->images))
                            @foreach(json_decode($value->images) as $key => $image)
                            <!-- <img src="{{asset('uploads/'.$image)}}"/> -->
                            <img src="{!! file_exists(public_path().'/uploads/'.$image)  ? asset('uploads/').'/'.$image : asset('/images/nomage.png') !!}">
                            @endforeach
                            @else
                            <img src="{{asset('/images/nomage.png')}}"/>
                            <!-- <img src="{{asset('/images/girlres.png')}}"/> -->
                            @endif
                    </div>
                    <h4>{{$value->name}}</h4>
                    @php
                    ...
                    @endphp
                            ...
                            <p style="height: 40px">{{\Illuminate\Support\Str::limit($taglessBody, 100, $end='...')}}</p>
                            <p style="height: 40px">{!!substr($ideas->content,0,100)!!}</p>
                            <
