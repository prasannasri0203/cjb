                    ...
                    <td width="520">
                        <table width="600" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td>&nbsp;</td>
                                <h3 style="margin-left: 7px;margin-top: 13px;">Dear User</h3>
                            ...
                            <tr>
                                <td style="color:#424242;font-size: 17px;font-family:'Calibri';font-weight: 600;">
                                   ...
                                   you have been invited cooljellybean,please start your registration
                                   </span>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td style="text-align: left;">
                                    <span style="color:#008dd4;font-size: 18px;font-family:'Calibri';">
                                     <?php echo '<a style="margin-left: 100px;" href="'.@$params.'">'.@$params.'</a>'; ?>
