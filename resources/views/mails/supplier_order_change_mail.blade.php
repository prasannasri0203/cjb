...
<body style="background: beige; width:100%;min-height: 100vh;">
    ...
    <div class="main-cont" style="width: 100%;margin: 0 auto; background: #fff;">
        ...
        <p style="display: inline; line-height: 1.6; font-family: sans-serif; margin-bottom: 20px;font-size: 15px;">You have been received New order. Please check detail for order no <b>{{ isset($content['order_ref']) ? $content['order_ref'] :'' }}.</b></p>
