...
<form id="product_add_form" action="{{ route('admin.product_new_variant_save') }}" class="form_class_validation" method="POST" enctype="multipart/form-data">
  @csrf
                        ...
                        <div class="feed d-flex justify-content-between">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input id="fileupload_1" class="fileupload" type="file" data-name="1" name="pv_upload[]" multiple="multiple" accept="image/x-png,image/jpg,image/jpeg"/><div class="error pv_upload_1"></div>
                                </div>
                            </div><?php /*
                            <div class="col-lg-6">
                                <div class="form-group">
...
function form_validation_check()
{
  ...
  url="{{ route('admin.product_new_variant_save') }}";
  $.ajax({
            type: "POST",
            url: url,
            headers:  {
