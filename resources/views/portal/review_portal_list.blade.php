...
@section('content')
          ...
          <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom">Review List</h2>
							
            </div>
          </header>
          <section>   

              <label class="text-left" style="padding-left:30px;">Review:</label>
...
<!-- 	                          <input type="text" class="form-control" name="print_type_name" id="" value="{{ old('print_type_name') }}"> -->
								...
								<select class="form-control" id="review_filter" name="review_filter">
									...
									<option id="option_1" value="1">Approve</option>
									<option id="option_0" value="0">Reject</option>
...
<script>
	function ShowModal(elem){
		...
		$("#option_"+status).attr("selected", "selected");
