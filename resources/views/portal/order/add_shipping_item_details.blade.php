...
@section('content')
          ...
          <section>   
            <div class="container-fluid">
              <div class="row">
                <div class="col-lg-12">
                <form  action="{{ route('admin.save_shipping_item_details') }}"  enctype="multipart/form-data" method="POST" role="form"  class="custom-form">
                ...
                <input type="hidden" name="order_prime_id" value="{{$id}}">                  
                  ...
                  <div class="form-group">
                    <label for="usr">Item No<span class="mandatory_field"> *<span></label>
                    <input type="text" class="form-control" name="item_id" readonly="readonly"   id="item_id" value="{{ $item_id }}" >
