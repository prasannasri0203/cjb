...
@section('content')
          ...
          <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom">Add-on  List</h2>
							<a href="javascript:void(0)" id="add_print_type" class="btn btn-primary" style="float: right;">Add-on Type</a>
            </div>
          </header>
          <section>   
            <div class="container-fluid">
		         	...
		         	<form id="print_type_form">
			            <input type="hidden" name="table_id" id="table_id" value="0">
	                        <div class="form-group">
	                          ...
	                          <input type="text" class="form-control" name="print_type_name" id="print_type_name" value="{{ old('print_type_name') }}" required>
		...
		$.ajax({
		  ...
		  success: function(data){
		  	if(data.status == true)
		  	{
				...
				iziToast.success({ title: 'Success', message: 'add-on list deleted successfully', position: 'topRight', });
				table.ajax.reload();
		  	}
		   }
		  });
...
$(document).ready(function(){
	...
	$.ajaxSetup({
		...
		"createdRow": function (row, data, index) {
            var info = print_type_table.page.info();
