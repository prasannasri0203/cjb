                          ...
                          <div class="page-content d-flex align-items-stretch">
                            ...
                            <nav class="side-navbar">
                              ...
                              <div class="sidebar-header d-flex align-items-center">
                                <div class="avatar">
                                  <a href="{{route('admin.profile.edit',base64_encode(Auth::user()->id)) }}">
                                    ...
                                    @else
                                    <img src="{{ asset('images/').'/logo.png' }}" alt="..." class="avatar_img_size img-fluid rounded-circle">
                                    @endif
                                  </a>
                                </div>
                                <div class="title">
                              ...
                              <ul class="list-unstyled">
                                <li class="{{ Request::url() == url('/admin') ? 'active' : '' }}"><a href="{{ url('/admin') }}"><i class="fa fa-tachometer"></i>@lang('general.Dashboard') </a></li>
                                @can('role-list')
                              ...
                              <li class="{{ (request()->is('admin/delivery_packing*')) ? 'active' : '' }}">
                                <a href="{{ route('admin.delivery_packing_list') }}"> <i class="fa fa-credit-card-alt"></i>Packing</a>
                              </li>
                              @endcan
                              @can('customer-list')
                              ...
                              <li class="{{ (request()->is('admin/colors*')) ? 'active' : '' }}">
                                <a href="{{ url('/admin/colors') }}"> <i class="fa fa-spinner"></i>Color </a>
                              </li>
                              @endcan
                              @can('product-list')
                              <li class="{{ (request()->is('admin/product*')) ? 'active' : '' }}"><a href="{{ url('/admin/product_list') }}"> <i class="fa fa-list-alt"></i>Product </a></li>
                              @endcan
                              <li class="{{ (request()->is('admin/print_type_list*')) ? 'active' : '' }}"><a href="{{ url('/admin/print_type_list') }}"> <i class="fa fa-print"></i>Add-on Features</a></li>
                              <li class="{{ (request()->is('admin/banner_list*')) ? 'active' : '' }}"><a href="{{ url('/admin/banner_list') }}"> <i class="fa fa-circle"></i>Manage Banner</a></li>
                              <li class="{{ (request()->is('admin/review_list*')) ? 'active' : '' }}"><a href="{{ url('/admin/review_list') }}"> <i class="fa fa-star"></i>Manage Review</a></li> 
                              @can('preset-list')
                              ...
                              @endcan
                              @can('emoji-list')
                              <li class="{{ (request()->is('admin/emoji_list*')) ? 'active' : '' }}"><a href="{{ url('/admin/emoji_list') }}"> <i class="fa fa-smile-o"></i>Manage Sellart </a></li>
                              @endcan
                              @can('order-list')
