...
<header class="page-header">
	<div class="container-fluid">
		...
		@if($user)<a href="{{ url('admin/order_index') . '?' . http_build_query(['art_id' => @$user->id ]) }}" class="btn btn-success" style="float: right;"> View Orders</a>
		<a style="margin-right: 10px; float: right;" href="{{ url('admin/artist_dashboard') . '?' . http_build_query(['id' => @$user->id ]) }}" class="btn btn-success" style="float: right;"> View Dashboard</a>@endif
	</div>
			...
			<div class="card">
				...
				<div class="card-body">
					...
					@endif
						...
						<div class="form-group">
							<label class="form-control-label">Date of Birth <span class="mandatory_field">*<span></label><?php
							if($user)
							{
							$diff = abs(strtotime($user->dob) - strtotime(date("Y-m-d")));
						...
						<div class="form-group">
							...
							<span class="file-image" id="image">
								<img src="{{url('profile').'/'.$user->profile_image}}" height="80px" width="80px" class="cms-image"/>
