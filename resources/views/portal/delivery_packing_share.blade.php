...
<header class="page-header">
	<div class="container-fluid">
		<h2 class="no-margin-bottom">@lang('Revenue Packings')</h2>
	</div>
</header>
<style type="text/css">
	#xButton {
					...
					<p></p>
						...
						<form method="POST" action="{{route('admin.delivery_packing.store')}}" enctype="multipart/form-data">
							...
							<div class="form-group">
								<label class="form-control-label">Packing Name <span class="mandatory_field">*<span></label>
							...
							<div class="form-group">
								<label class="form-control-label">Packing Type <span class="mandatory_field">*<span></label>
								<!-- <select class="form-control" name="type" value="{{ old('type') }}">
									<option value="">Please Select Type</option>
									<option value="1">Delivery</option>
									<option value="2">Packing</option>
								</select> -->
								<input type="text"  class="form-control" name="type" value="Packing" style="pointer-events: none;">
                            ...
                            <div class="form-group">
								<label class="form-control-label">Packing Value <span class="mandatory_field">*<span></label>
                            ...
                            <div class="form-group">
								<label class="form-control-label">Packing Description <span class="mandatory_field">*<span></label>
