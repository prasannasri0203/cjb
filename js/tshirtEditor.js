 	...
 	$(document).ready(function() {
		...
		document.getElementById('add-text').onclick = function() {
		    ...
		    var textSample = new fabric.Text(text, {
		      ...
		      top: fabric.util.getRandomInt(100, 100),
        ...
        $('body').on('click', '.img-polaroid', function (e){
	        ...
	        var width = fabric.util.getRandomInt(10, 11);
        ...
        $('body').on('click', '#flip', function (e){
		   ...
		   //function() {
			   	if ($(this).attr("data-original-title") == "Show Back View") {
			        ...
			        $("#tshirtFacing").attr("src","public/img/t-shirts/"+IMAGE_NAME+"_back.png");
			    	...
			    	$("#tshirtFacing").attr("src","public/img/t-shirts/"+IMAGE_NAME+"_front.png");
